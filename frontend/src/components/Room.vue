...
<v-card style="width:300px; margin-left:5%;" outlined>
    ...
    <v-card-text style = "margin-left:-15px; margin-top:10px;">
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="RoomNumber" v-model="value.roomNumber"/>
          </div>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="UsedCount" v-model="value.usedCount"/>
          </div>
          <div class="grey--text ml-4" v-else>
            UsedCount :  {{value.usedCount }}
          </div>
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="ConferenceId" v-model="value.conferenceId"/>
          </div>
          <div class="grey--text ml-4" v-else>
